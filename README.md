...
| [Honu](https://gitlab.com/EmileRolley/school-projects/-/tree/master/honu) | A programming language and toolchain for image creation. | *Grammaire et analyse lexicale* <br> <small>Highest score (20/20)</small> | ROLLEY Emile <br> THOMAS Hugo                    | **OCaml**           | `Make` <br> `Dune` <br> `Menhir` <br> `ocamllex` <br> `Docker` <br> `GitLab-CI` | Unit testing | 2294     |
